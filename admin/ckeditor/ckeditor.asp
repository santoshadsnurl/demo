...
' URL: https://www.webdevbros.net/2007/04/26/generate-json-from-asp-datatypes/
'**************************************************************************************************************
'' @CLASSTITLE:		JSON
...
'' @CDESCRIPTION:	Comes up with functionality for JSON (https://json.org) to use within ASP.
...
class JSON
	...
	''					RFC4627#2.5 - https://www.ietf.org/rfc/rfc4627.txt?number=4627
