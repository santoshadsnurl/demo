...
if(isset($_POST['submit']) && $_POST['submit']=="add")
{
	...
	if($sql_duplicate=$conn->query($query_duplicate))
	{
		...
		else
		{
			...
			{
				$query_insert = "INSERT INTO products SET title='".$title."',sku='".$sku."',hot='".$hot."',arabic_title='".$arabic_title."',arabic_description='".$arabic_description."',quantity='".$quantity."',sale_price='".$sale_price."',category_id='".$category_id."',sub_category_id='".$sub_category_id."',sub_sub_category_id='".$sub_sub_category_id."',brand_id='".$brand_id."',description='".$description."',price='".$price."',specification='".$specification."',care_instructions='".$care_instructions."',questions='".$questions."',alt_tag='".$alt_tag."',alias='".$alias."',meta_title='".$meta_title."',meta_keyword='".$meta_keyword."',meta_description='".$meta_description."'";
					...
					<div class="panel-body" style="padding:30px;">
						<form method="post" name="<?php echo strtolower($pagename); ?>" id="products" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="radio" name="hot" value="1" <?php if($hot=="1") { echo "checked"; } ?> />Yes
								<input type="radio" name="hot" value="0" <?php if($hot== "0") { echo "checked"; } ?> />No
					        </div>
							<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<span class="red" style="color:red;"><font size="2" width="bold">[ Size : 217*250 ]px</font></span>	
									</div>
								</div>
							</div>
							<div class="form-group">
													...
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																...
																<span class="red" style="color:red;"><font size="2" width="bold">[ Size : 427*985 ]px</font></span>	
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
