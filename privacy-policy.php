	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'><?php echo $newobject->getInfo($conn,"pages","title",13); ?></li>
			</ul>
    ...
    <div class="terms-conditions-page">
      <div class="row">
        <div class="col-md-12 terms-conditions">
          <h2 class="heading-title"><?php echo $newobject->getInfo($conn,"pages","title",13); ?></h2>
          <div class="">
            <?php echo $newobject->getInfo($conn,"pages","description",13); ?>
            <h3>Contact Us</h3>
