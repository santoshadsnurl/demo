...
if(isset($_REQUEST['alias']) && $_REQUEST['alias']!="")
{
	...
	if(isset($_REQUEST['filter_category_id']) && $_REQUEST['filter_category_id']!="")
	{
		...
		$addsubqry .= " AND sub_category_id IN ($filter_category_id) ";
	}
  ...
  <div class="col-md-3 col-sm-6">
    <div class="sidebar"> 
      ...
      <div class="filter">
		...
		<?php
		$sub_sub_categories_list = $newobject->getconrecords($conn,"sub_sub_categories","sub_category_id = '$sub_category_id_categories'");
  ...
  <div class="row">
    ...
    <div class="col-md-3 col-ms-4">
      <div class="product product-sec-item">
        <div class="product-image"> <a href="<?php echo $site_root; ?>detail/<?php echo $categories_listing_result['alias']; ?>/"><img src="<?php echo $site_root; ?>uploads/products/<?php echo $categories_listing_result['image']; ?>" alt="#"></a> </div>
        <div class="product-info text-left">
          ...
          <div class="product-price"> <span class="price"> <i class="fa fa-inr" aria-hidden="true"></i><?php echo $categories_listing_result['sale_price']; ?> </span> <span class="price-before-discount"> <i class="fa fa-inr" aria-hidden="true"></i> <?php echo $categories_listing_result['price']; ?></span> <span class="dis-off"> <?php echo number_format((100 - ($categories_listing_result['sale_price'] * (100/$categories_listing_result['price']))),0); ?>% Off </span> </div>
	...
	<ul class="pagination">
	<?php if($total_page>1) { echo $pre;?>
	&nbsp;<?php echo $page;?>&nbsp;<?php echo $next; } ?>
	</div>
	</div>
	<?php
	}
