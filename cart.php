...
<div class="body-content"> 
  <!-- /.body-content -->
  <div class="container">
    <div class="my-wishlist-page cartpage">
      <div class="row">
        <?php if($cart_session_mob->num_rows>0) { ?>
        <div class="col-xs-12">
          <ul class="speratelink tpsperatelink">
            <li class="active"> <a href="<?php echo $site_root; ?>cart/"> cart</a> </li>
        ...
        <div class="col-md-9 my-wishlist my-cart">
          <div class="shoppingcart">
            <h4>SHOPPING CART <span> Price</span></h4>
          </div>
          <div class="table-responsive">
			...
			while($result_cart = $cart_session_mob->fetch_array(MYSQLI_ASSOC))
			{
				...
				$category_id_chk = $newobject->getInfo($conn,"products","category_id",$product_id);
				...
				$srl++;
				?>
				<tr class="wishlistarea cart_custom ">
				<td class="col-md-2"><div class="wishlistitemimg"> <img src="<?php echo $site_root; ?>uploads/products/<?php echo $image; ?>" alt="imga"> </div></td>
				<td class="col-md-10"><div class="row bor_productcus">
				<div class="col-md-8">
				<div class="product-name"><a href="<?php echo $site_root; ?>detail/<?php echo $alias; ?>/"><?php echo $title; ?></a></div>
				<?php if($product_size!="") { ?>
				...
				<span class="price_off"><a href="<?php echo $site_root; ?>">Continue  Shopping </a></span> <span class="remove_item"><a href="javascript:void(0);" onClick="DeleteProduct('<?php echo $product_id; ?>');"> Remove </a></span>
				...
				<?php
				if($category_id_chk == 8) 
				{
					$cus_session_mob = $newobject->getconrecords($conn,"customize_products", "session_id = '$session_id'");
					if($cus_session_mob->num_rows>0)
					{
						while($result_cus = $cus_session_mob->fetch_array(MYSQLI_ASSOC))
						{
							?>
							<div class="cart_custombtn">
							<h3 class="cart_custom_title">Customize Information</h3>
							<img src="<?php echo $site_root; ?>uploads/customize/<?php echo $result_cus['image']; ?>" alt="cup images"  class="imng-responsive"/>
							<h3 class="cart_custom_content"><span> your Special message</span><?php echo $result_cus['message']; ?></h3>
							</div>
							<?php
						}
					}
        ...
        <div class="col-md-3 col-12">
          <div class="sidebarmyaccount">
            <div class="myprofile">
              <div class="subtotal">
                <h5>Subtotal (<?php echo $cart_session_mob->num_rows; ?> items): &#x20b9;<span id="subtotaltothtml"><?php echo number_format($newobject->subTotal($conn,$session_id),2); ?></span> </h5>
                <a href="<?php echo $site_root; ?>checkout/" class="btn btn-warning btn-blues"> Proceed to buy </a> </div>
            </div>
          </div>
        </div>
        <?php } else { ?>
...
if($most_viewed_products->num_rows>0)
{
	?>
    <!-- ======= Recently Viewd ======= -->
    <section class="section featured-product eletronic-product recently_view_pro wow fadeInUp rowarea">
      <div class="container">
        <div class="row">
