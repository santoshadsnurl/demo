      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="speratelink tpsperatelink">
            ...
            <li class="active"> <a href="<?php echo $site_root; ?>checkout-to-ship/"> shipping</a></li>
        ...
        <div class="col-md-9 my-wishlist">
          <div class="select_delivery">
			...
			<form name="paypalfrm" id="paypalfrm" action="<?php echo $site_root; ?>checkout-to-payment/" method="post">
            ...
            <div class="myprofile">
              <div class="pricedetail">
                ...
                <ul>
                  ...
                  <li> Bag Discount<span>&#x20b9;<?php echo number_format($newobject->getdiscount($conn,$session_id),2); ?></span> </li>
