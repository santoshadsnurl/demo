...
if(isset($_REQUEST['alias']) && $_REQUEST['alias']!="")
{
	...
	$product_image = $newobject->getdata($conn,"products","image","alias",$alias);
...
<div class="pd_page_ram">
    ...
    <div class="productleft">
            ...
            <?php 
				...
				if($product_image->num_rows>0)
				{
					...
					while($product_image_result = $product_image->fetch_array(MYSQLI_ASSOC))
					{
						$a++;
						?>
                <li class=" <?php if($a==1) { ?>thumbnail-active <?php } ?>"> <a href="<?php echo $site_root; ?>uploads/product_images/<?php echo $product_image_result['product_image']; ?>" class="image"  data-easyzoom-source="<?php echo $site_root; ?>uploads/product_images/<?php echo $product_image_result['product_image']; ?>"> <img width="90" height="90" src="<?php echo $site_root; ?>uploads/product_images/<?php echo $product_image_result['product_image']; ?>" class="<?php if($a==1) { ?>attachment-shop_thumbnail<?php } ?>" alt="62" /> </a> </li>
                <?php
					}
				}
				?>
      ...
      <div class="buybtn">
        ...
        <?php
				...
				{
				?>
					<a href="javascript:void(0);" class="btn btn-blues hover_effect1 btn_cutm"  data-toggle="modal" data-target="#myModalcustomize"> 
         <i class="fa fa-pencil-square-o" aria-hidden="true"></i> customize</a>
				<?php
				}
			}
		}
    ...
    <div class="productright">
      <div class="custom-bread">
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="javascript:void(0);"><?php echo $product_title; ?></a></li>
        </ol>
      </div>
      <div class="socialshare"> <span>SKU</span>
        <ul>
          <li><a href="javascript:void(0);"><?php echo $sku; ?></a></li>
          <!--<li><a href="#"><img src="<?php echo $site_root; ?>assets/images/ico6.png" /></a></li>
          <li><a href="#"><img src="<?php echo $site_root; ?>assets/images/ico9.png" /></a></li>
          <li><a href="#"><img src="<?php echo $site_root; ?>assets/images/ico10.png" /></a></li>-->
        </ul>
      </div>
      <h1><?php echo $newobject->getdata($conn,"products","arabic_title","alias",$alias); ?></h1>
      <div class="pricing">
        <div class="mrp_price"> M.R.P: <span class="mrp_price2 a-text-strike "><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $product_price; ?> </span></div>
        <span class="price1"><small>Price:</small> <i class="fa fa-inr" aria-hidden="true"></i><?php echo $product_sale_price; ?></span> <span class="price3">(<?php echo number_format((100 - ($product_sale_price * (100/$product_price))),0); ?>% Off)</span>
      ...
      <div class="producttabs producttabs_des"><?php echo $newobject->getdata($conn,"products","description","alias",$alias); ?></div>
    </div>
  </div>
  <div class="detailtabs">
    ...
    <div id="tab-1" class="tab-content current "> <?php echo $newobject->getdata($conn,"products","arabic_description","alias",$alias); ?> </div>
    <!--tab-->
    <div id="tab-2" class="tab-content"> <?php echo $newobject->getdata($conn,"products","specification","alias",$alias); ?> </div>
    <!--tab-->
    <div id="tab-3" class="tab-content "> <?php echo $newobject->getdata($conn,"products","care_instructions","alias",$alias); ?> </div>
    <!--tab-->
    ...
    <div id="tab-5" class="tab-content">
      <section>
        <div class="container-fluid"> <?php echo $newobject->getdata($conn,"products","questions","alias",$alias); ?> </div>
      </section>
      ...
      <div class="profilelist no-border">
        <div class="row">
          <div class="post_form">
            ...
            <div class="form-group">
              <textarea type="text" class="form-control"  placeholder="Enter Your Enquiry"></textarea>
            </div>
            <div class="sunmits">
...
$(window).on('load',function(){
  setTimeout(function(){ $(".productleft").css("display","block") }, 200);
});
</script>  -->
